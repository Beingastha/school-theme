...
$apply_intro   = esb_pg( 'adm_apply_intro', 'Fill out the provisional admission form below and our admissions team will be in touch.' );
$office_addr   = esb_pg( 'adm_office_address', 'Govt. Subhash Excellence Higher Secondary School, Bhopal' );
$office_phone  = esb_pg( 'adm_office_phone', '+0755-2552490' );
$office_email  = esb_pg( 'adm_office_email', 'govt.hss.excellence.subhash@gmail.com' );
$office_hours  = esb_pg( 'adm_office_hours', 'Mon – Sat · 8:00 AM – 4:00 PM' );
?>
<main id="main">
	...
	<section class="section" id="apply" style="background:var(--cream)">
		<div class="container">
			<div class="reveal" style="max-width:760px;margin:0 auto;text-align:center">
				<span class="eyebrow center" data-en="Admission Enquiry" data-hi="प्रवेश पूछताछ"><?php esc_html_e( 'Admission Enquiry', 'excellence-school' ); ?></span>
				...
				<p class="muted" style="margin:14px auto 0;max-width:56ch"
				   data-en="<?php echo esc_attr( $apply_intro ); ?>"
				   data-hi="<?php echo esc_attr( esb_pg_hi( 'adm_apply_intro', 'नीचे प्रावधिक प्रवेश फॉर्म भरें, हमारी प्रवेश टीम आपसे संपर्क करेगी।' ) ); ?>">
					<?php echo esc_html( $apply_intro ); ?>
				</p>
				<div class="help-box" style="text-align:left;margin:32px 0">
					...
					<p><a href="mailto:<?php echo esc_attr( $office_email ); ?>"><?php echo esc_html( $office_email ); ?></a></p>
					<p style="margin-top:12px"
					   data-en="<?php echo esc_attr( $office_hours ); ?>"
					   data-hi="<?php echo esc_attr( esb_pg_hi( 'adm_office_hours', 'सोम – शनि · प्रातः 8 – सायं 4' ) ); ?>">
						<?php echo esc_html( $office_hours ); ?>
					</p>
				</div>
			</div>
			<div class="form-card" style="max-width:760px;margin:24px auto 0">
	...
	<section class="adm-cta">
		<div class="container reveal" style="text-align:center;padding:clamp(56px,7vw,90px) 28px">
			...
			<div class="cta-row" style="display:flex;justify-content:center;gap:16px;flex-wrap:wrap;margin-top:32px">
				...
				<a href="tel:<?php echo esc_attr( preg_replace( '/[^0-9+]/', '', $office_phone ) ); ?>"
